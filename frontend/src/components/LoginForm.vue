...
<form id="login-form" class="w-full px-25 py-5 flex flex-col items-center justify-center bg-neutral-700 bg-opacity-50 text-white backdrop-blur-sm" @submit.prevent="submit">

    <p class="mb-5 text-3xl select-none">{{t('form.login')}}</p>
    ...
    <button @click="loginUser(formData)" type="submit" class="btn btn-blue h-8 font-semibold text-base">{{t('button.signin')}}</button>
    
    <div class="mt-5 flex flex-row gap-1 font-semibold text-white select-none">
