...
<template>
    <div id="navbar"
        ...
        <div id="available-space"
            ...
            <div id="outer-rect"
                ...
                <div id="inner-rect" class="h-full bg-neutral-400 dark:bg-gray-400" :style="{
    ...
    <div v-if="menuOpen" id="user-menu"
        ...
        <button v-if="userInfo.isAdmin" @click="goToAdmin()"
            class="flex cursor-pointer gap-1 rounded-md px-2 py-1 text-sm hover:bg-neutral-200 dark:hover:bg-gray-700">
            <Icon icon="mdi:shield-account-outline" :inline="true" width="20" />
            Admin panel
        </button>
