...
<template>
    <div
        ...
        <p>{{ loadingMessage }}</p>
        <div id="progress-bar-container" class="mt-2 h-2 w-[32rem] rounded-md bg-neutral-400 dark:bg-gray-600">
            <div
                id="progress-bar-main"
                class="progress-bar h-full rounded-md bg-neutral-800 dark:bg-gray-400"
